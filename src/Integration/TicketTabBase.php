...
abstract class TicketTabBase extends CommonGLPI
{
    ...
    private static function renderClientVersionCard(Ticket $ticket, int $version, array $rows): void
    {
        ...
        echo '<div id="' . $wrapId . '" '
           ...
           . 'data-pdfjs-integrity="' . htmlspecialchars((string) ($vendor['pdfJsIntegrity'] ?? ''), ENT_QUOTES) . '" '
           . 'data-pdfworker="' . htmlspecialchars($vendor['pdfWorker'], ENT_QUOTES) . '" '
           . 'data-pdfworker-integrity="' . htmlspecialchars((string) ($vendor['pdfWorkerIntegrity'] ?? ''), ENT_QUOTES) . '" '
    ...
    private static function emitPreviewScript(): void
    {
        ...
        echo '<script>(function(){'
           ...
           . '  function loadScript(src, integrity){ return new Promise(function(res,rej){'
           ...
           . '    try {'
           . '      if (!window.pdfjsLib) await loadScript(wrap.dataset.pdfjs, wrap.dataset.pdfjsIntegrity);'
